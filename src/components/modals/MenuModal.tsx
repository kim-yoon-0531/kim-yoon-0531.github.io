...
const menuItems = [
  { name: '도가니탕', img: '/images/menu/01.webp' },
  { name: '생연어회', img: '/images/menu/02.webp' },
  { name: 'LA목살구이', img: '/images/menu/03.webp' },
  { name: '수란', img: '/images/menu/04.webp' },
  { name: '육회초밥', img: '/images/menu/05.webp' },
  { name: '양념게장', img: '/images/menu/06.webp' },
  { name: '칠리새우', img: '/images/menu/07.webp' },
  { name: '치즈볼', img: '/images/menu/08.webp' },
]
